...
function clearOrderInterface(previousType) {
    if (previousType === "delivery") {
        ...
        document.getElementById("order-right-delivery-address").textContent =
            "не указан";
        document
        ...
        document.getElementById("order-right-pickup-address").textContent =
            "не указан";
...
class PayErrorModal {
    ...
    #init() {
        ...
        this.#deliveryModalText = document.getElementById(
            "error-pay-delivery-text"
        );
        this.#pickupModalText = document.getElementById(
            "error-pay-pickup-text"
        );

        if (
            !this.#deliveryModal ||
            !this.#pickupModal ||
            !this.#deliveryModalText ||
            !this.#pickupModalText
        ) {
